    ...
    return Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            ...
            Provider.of<TabPageProvider>(context).index != 0
                ? Provider.of<TabPageProvider>(context).openPage
                : Column(
                    children: [
                      Body(),
                      SizedBox(height: 8),
                      (currentIndex == 0)
                          ...
                          : (currentIndex == 1)
                              ? Objective()
                              : (currentIndex == 2) ? Objective() : Objective(),
                    ],
                  ),
          ],
        ));
    ...
    return AppBar(
      ...
      actions: <Widget>[
        ...
        Padding(
          ...
          child: IconButton(
              icon: Icon(Icons.search, size: 33, color: Color(0xFFFE9801)),
              onPressed: () {}),
        ),
        SizedBox(
          width: 10,
